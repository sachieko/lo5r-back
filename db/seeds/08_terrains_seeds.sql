...
Mechanics: Attacks against characters in the terrain have the TN increased by 1. Characters cannot see more than 2 [Range Bands] (a spear length) through obscuring terrain, for those outside this is measured from the edge of the terrain while for those inside it is measured from their position.', 'Core Rulebook', 267),
-- 7 Confining
...
[Duel] or [Skirmish] Mechanics: If a [Duel] or [Skirmish], any checks involving a weapon or technique with a range higher than 1 has the TN increased by 2.
