...
'How your character views the tenets of Bushido affects how they approach their work as a samurai.', 'How your character views the tenets of Bushido affects how they approach their work as a samurai.'),
('9. Distinctions: What is your greatest accomplishment so far?',
'Determine an accomplishment that gives your character an advantage of confidence in certain situations.', 'Determine an accomplishment that gives your character an advantage of confidence in certain situations.'),
('10. Adversities: What holds you back the most?',
'Determine an adverse experience which gives your character a disadvantage of confidence in certain situations.', 'Determine an adverse experience which gives your character a disadvantage of confidence in certain situations.'),
('11. Passions: What make you feel at peace?',
'Determine what makes your character feel at peace and relaxed.', 'Determine what makes your character feel at peace and relaxed.'),
('12. Anxieties: What is your greatest concern, fear, or trouble?',
'Determine what is most likely to add more stress to your character due to fear, concern, or anxiety.', 'Determine what is most likely to add more stress to your character due to fear, concern, or anxiety.'),
('13. Who have you learned the most from during life?',
'Determine someone your character learned from, either a mentor or an adversary, and how they affected your character as a person.', 'Determine someone your character learned from, either a mentor or an adversary, and how they affected your character as a person.'),
('14. What do people notice first about you?',
'Start to give your character some personality in general situations and in terms of first impressions.', 'Start to give your character some personality in general situations and in terms of first impressions.'),
('15. How do you react to stressful situations?',
'Give your character extra personality when they''re becoming stressed or about to unmask.', 'Give your character extra personality when they''re becoming stressed or about to unmask.'),
('16. What are your pre-existing relationships with other clans, families, and organizations?',
'Does your character have any noteworthy relationships with others that might impact who they are?', 'Does your character have any noteworthy relationships with others that might impact who they are?'),
('17. How would your character''s parents describe them?',
'Did your character get along with their parents or was there animosity? Your character has a skill they developed as a result of this relationship.', 'Did your character get along with their parents or was there animosity? Your character has a skill they developed as a result of this relationship.'),
...
'This is your characters first name.', 'This determines your characters first name.'),
('20. How should your character die?',
'Every samurai lives 3 feet from death - the length of a katana. How does your character think about meeting their end?', 'How does your character face the likelihood of death?');