...
Mechanics: All critical strikes inflicted by the character or on the character have 2 higher severity, and once per scene if the character kills another person they gain a void point.
...
Mechanics: Actions that require a roll cannot be performed and are unable to defend against damage by taking fatigue. Characters can still perform checks for resisting effects or critical strikes. If they take a critical strike, they also gain the Unconscious condition.
