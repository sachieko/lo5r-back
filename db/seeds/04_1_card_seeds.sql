...
VALUES
-- Rule 1: Rolling
(1, 'Resolving Explosive Successes', 'For any explosive successes that were kept, roll another die of the same type. It also counts as a success. Then you can choose whether to keep the additional rolled die after, and if it is also an explosive success you can roll once more.'),
