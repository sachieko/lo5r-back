...
(
  'Skirmish', -- title
  E'Skirmishes have a unique set of modifications for [Conflict] scenes as described below. Additionally, one may enter a clash during a [Conflict] which are a [Duel] embedded in a skirmish and so use those rules.\n\nInitiative is determined with a TN 1 [Tactics] check, and 💮 can be spent to gain additional information about the surroundings or undertake small preparatory tasks.\n\nSkirmishes make the most use of [Range Band]s, and each character can move 1 [Range Band] before or after their action as part of their turn
