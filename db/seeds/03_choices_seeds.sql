...
'Starting Techniques: [Kata] [Lord Hida''s Grip], and either [Kata] [Striking as Earth] or [Kata] [Striking as Water].
...
Starting Outfit: [Lacquered Armor], traveling clothes, daisho ([Katana] and [Wakizashi]), [Tetsubo] or [Otsuchi], [Club], [Knife], traveling pack.'),
...
Starting Outfit: Traveling clothes, ashigaru armor, daisho ([Katana] and [Wakizashi]), [Yari] or [Yumi] and quiver of arrows, [Knife], traveling pack, finger of jade.'),
(3, 'Kaiu Engineer School (Artisan, Bushi)', '+1 Earth and +1 Fire Rings, Choose five from: +1 [Command], +1 [Design], +1 [Labor], +1 [Martial Arts Ranged], +1 [Medicine],+1 [Smithing], +1 [Theology]. Honor: 40', 
'Starting Techniques: [Kata] [Tactical Assessment] and [Shuji] [Stirring the Embers], [Stonewall Tactics]. 
...
Starting Outfit: Traveling clothes, ceremonial clothes, ashigaru armor, daisho ([Katana] and [Wakizashi]), [Club], [Oyumi], quiver of bolts, traveling pack.'),
...
'Starting Techniques: [Kata] [Striking as Earth] or [Striking as Fire], [Invocations] [Armor of Earth] and [Jade Strike], [Rituals] [Commune with the Spirits] and [Threshold Barrier]. 
